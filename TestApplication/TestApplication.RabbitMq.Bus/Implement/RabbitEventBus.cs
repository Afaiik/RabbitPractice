...
namespace TestApplication.RabbitMq.Bus.Implement
{
    public class RabbitEventBus : IRabbitEventBus
    {
        //TODO: Creo que aca cambia la implementacion con Rebus o el que usemos
        private readonly IMediator _mediator;

        //Porque el mensaje que enviemos puede ser de cualquier tipo
        ...
        {
            //Crear conexion a mi docker server
            ...
            where TH : IEventHandler<T>
        {
            ...
            {
                throw new ArgumentException($"The handler {eventHandlerType.Name} was registered before by {eventName}");
            }
